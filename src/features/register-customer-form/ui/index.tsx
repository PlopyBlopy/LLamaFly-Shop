...
import { CustomerForm } from "@/shared/forms/register-form";

interface Props {
  onRegister: (user: UserRegister, profile: ProfileRegister, seller: CustomerRegister) => void;
}

export const RegisterCustomerForm = ({ onRegister }: Props) => {
  ...
  const handleSubmitForm = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onRegister(userRegister, profileRegister, customerRegister);
    } catch (error: any) {
