...
import { getProductCards, ProductCard, QueryParams } from "../../../../shared/product-service-products"
...
export default class ProductCardStore
{
    ...
    setDependencies(deps: {filterStore: FilterStore, productImageStore: ProductImageStore}) {
    ...
    getProductCardListAction = async () => {
        try {
            ...
            await this.productImageStore.getProductsImagesAction(this.productCardList);
